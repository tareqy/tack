...
5. Add 8+ items to one card: the rows scroll inside the section (4 visible), Labels/Due Date/Save stay put; resize the sheet taller — everything still composed; a long Brief AND a long checklist together still keep the footer visible.
